...
struct ProspectsView: View {
    ...
    var sortedAndFilteredProspects: [Prospect] {
        if sortType == .byName {
    ...
    @State private var showingSortingMethod = false
    
    var body: some View {
        NavigationView {
            List {
                ForEach(sortedAndFilteredProspects) { prospect in
                    HStack {
            ...
            .confirmationDialog("Choose a sorting method", isPresented: $showingSortingMethod) {
                Button("By name") { sortType = .byName }
                Button("By most recent") { sortType = .byMostRecent }
                Button("Canceel", role: .cancel) { }
            }
        }
    }
